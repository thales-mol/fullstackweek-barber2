...
import { saveBoking } from "../_actions/save-booking";
...
const ServiceItem = ({
  ...
  const HandleBookingSubmit = async () => {
    ...
    try {
      ...
      //codigo abaixo  esta separando o horario em uma lista
  ...
  const timeList = useMemo(() => {
    ...
    return generateDayTimeList(date).filter((time) => {
      //mostrar somente horários disponiveis 
  ...
  return (
    //importante colocar as divs
    <Card>
      <CardContent className="p-3 w-full">
        <div className="flex gap-4 items-center w-full">
          <div className="relative min-h-[110px] min-w-[110px] max-h-110px max-[110px]:">
            <Image
