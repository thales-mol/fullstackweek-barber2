/*
  ...
  - Added the required column `barbershoId` to the `Service` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "barbershoId" TEXT NOT NULL,
